		...
		http.sessionManagement(sessionConfig -> sessionConfig.sessionCreationPolicy(SessionCreationPolicy.ALWAYS))
				...
				.cors(corsConfig -> corsConfig.configurationSource(new CorsConfigurationSource() {
					...
					public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
						...
						config.setAllowedOrigins(Collections.singletonList(frontEndUrl)); // Allowing only
																										// this origin
						config.setAllowedMethods(Collections.singletonList(frontEndUrl)); // Allowing all HTTP methods
...
//								"/api/**",
	...
	public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
		...
		TenantUserPwdAuthenticationProvider authenticationProvider = new TenantUserPwdAuthenticationProvider(userDetailsService, passwordEncoder); // Custom authentication provider
