...
@Slf4j
@Component
@Profile("dev")  // This configuration is active in all profiles except "prod" (production).
@RequiredArgsConstructor  // Automatically generates a constructor for all final fields.
public class TenantUserPwdAuthenticationProvider implements AuthenticationProvider {
